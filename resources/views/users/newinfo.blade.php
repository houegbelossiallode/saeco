    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-content">
                ...
                <form action="{{ route('info.add', $idclient) }}" method="post">
                    @method('post')
                    @csrf
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="titre" name="titre" type="text"
                                class="validate @error('titre') is-invalid @enderror" value="{{ old('titre') }}">
                        ...
                        <div class="input-field col s12">
                            <textarea id="contenu" name="contenu" class="materialize-textarea validate @error('contenu') is-invalid @enderror">{{ old('contenu') }}</textarea>
