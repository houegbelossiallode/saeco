    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-content">
                ...
                <form action="{{ route('typeproduit.add') }}" method="post">
                    @method('post')
                    @csrf
                    <div class="row m-t-40">
                        <div class="input-field col s6">
                            <select id="branche" name="branche" data-error=".errorTxt6"
                                ...
                                <option value="Vie" @if (old('branche') == 'Vie') selected @endif>Vie</option>
                                <option value="Non vie" @if (old('branche') == 'Non vie') selected @endif>Non vie</option>
                            </select>
                            <label>Branche</label>
                            @error('branche')
